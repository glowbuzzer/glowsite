...
//              End of Union
        ...
        /** 
        Configuration for a moveJoints. Just needs the kinematicsConfiguration (KC) index
         */
        ...
        /** 
        Status information for a moveJoints.
         */
        ...
        export type MoveJointsCommand = {
                    ...
                    positionReference?:POSITIONREFERENCE;
                    /**  the index of the move parameters (amax, vmax etc.) to be used for the move */
        ...
        /** 
        Config parameters for MoveJointsAtVelocity
         */
        ...
        /** 
        Config parameters for moveLine
         */
