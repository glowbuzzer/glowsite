...
a docking layout framework and [tiles](tiles/overview) which provide a consistent look and feel for your application and a basis for building your own custom user interface.
