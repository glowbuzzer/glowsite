...
```jsx
import {GlowbuzzerApp, DockLayoutProvider, DockLayout, GlowbuzzerTileDefinitions} from "@glowbuzzer/controls";
...
```jsx
import {GlowbuzzerApp, DockLayoutProvider, DockLayout, GlowbuzzerTileDefinitions,DockTileDefinitionBuilder} from "@glowbuzzer/controls";
...
```jsx
import {GlowbuzzerApp, DockLayoutProvider, DockLayout, DockTileDefinitionBuilder, GlowbuzzerTileDefinitions, ThreeDimensionalSceneTile} from "@glowbuzzer/controls";

const MyApp=() => {
    const myTileDefinition=DockTileDefinitionBuilder(GlowbuzzerTileDefinitions.THREE_DIMENSIONAL_SCENE)
        .id("mytile")
        .title("My Tile")
        .render(() => {
