...
The world frame W
  ...
  Between these frames transformations exist so that given a set of coordinates in (say) the work frame we want work out the equivalent coordinates in the (say) the world frame
