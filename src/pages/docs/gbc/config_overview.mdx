...
See, <GlowsiteLink to="/docs/types/GlowbuzzerConfig">the schema documentation for the Config object</GlowsiteLink> for an overview of the contents of the config.
...
### `moveParameters: {}, task: {}, activity: {}, frames: {}, triggerOn: {}` configuration and parameter definition
