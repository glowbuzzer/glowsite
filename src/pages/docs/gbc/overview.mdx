...
We test &gbc on the STM32 platform. This is using ST's dual-core ARM M7 / M4 range of microcontrollers.
...
See <Link to = "/docs/gbc/running">Running GBC</Link>
...
See <Link to = "/docs/gbc/configuration">Configuration of GBC</Link>
...
The wire format of &gbc is documented <Link to="/docs/gbc/schema">here</Link>.

## Javascript and &gbc

&gbc includes a JavaScript interpreter. This uses the <a href="https://duktape.org/">Duktape</a> embeddable Javascript engine.
...
* If a digital input changes, then exe
...
The main benefit of this Javascript code is that it provided faster response to events than React code. Around a 10ms response time is expected for this code.
