...
<Image meta={jvl_mis_drive} alt="JVL MIS Drive" preset="body" width={"50%"} />
...
<Image meta={jvl_m12_rj45} alt="JVL M12 RJ45 connector" preset="body" width={"100%"} />
...
<Image meta={jvl_unboxing} alt="JVL MIS unboxing" preset="body" width={"100%"} />
...
<Image meta={jvl_power_connector_prep} alt="JVL power cable prep" preset="body" width={"100%"} />
...
<Image meta={jvl_scan} alt="JVL scan" preset="body" width={"100%"} />
...
<Image meta={jvl_ethercat} alt="JVL MacTalk EtherCAT" preset="body" width={"100%"} />
...
<Image meta={jvl_dc_sync_ok} alt="JVL sync ok" preset="body" width={"100%"} />
