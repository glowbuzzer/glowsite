...
<Tldr>
    <TldrItem>Open source EtherCAT master</TldrItem>
    <TldrItem>CiA 402 based state machine framework</TldrItem>
    <TldrItem>Runs on Linux & Microcontroller</TldrItem>
    <TldrItem>Interfaces GBC to EtherCAT network</TldrItem>
</Tldr>
