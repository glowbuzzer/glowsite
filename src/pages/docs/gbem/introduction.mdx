...
<Card size="small" style={{ width: 300, float: 'right'}}>
    <Card.Meta title={"TLDR"} style={{padding: '10px 0 0 0'}} avatar={<Avatar style={{ backgroundColor: '#000000'}} size="small" icon={<AimOutlined />} />}/>
    <Divider />
    <ul>
    <li>Open source EtherCAT master</li>
    <li>CiA 402 based state machine framework</li>
    <li>Runs on Linux & Microcontroller</li>
    <li>Interfaces GBC to EtherCAT network</li>
    </ul>
</Card>
