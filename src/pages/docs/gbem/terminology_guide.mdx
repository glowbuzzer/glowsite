...
* iomap - the mapping between EtherCAT slave IO and &gbc and PLC variables. For example, a digital input on a PDO (e.g. channel 1 on an EL1008 module) can be mapped to a &gbc IO so that code running the the front-end can act on its status
