...
1. Getting started with the example hardware - <GlowsiteLink to="/docs/gbem/getting_started_with_example_hardware">Getting started with example hardware</GlowsiteLink>
