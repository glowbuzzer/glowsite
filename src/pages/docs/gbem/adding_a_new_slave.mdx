...
If the slave is a drive, then more functions will be needed - see the [Adding a new drive](/docs/gbem/adding_a_new_drive) documentation.
...
See the examples below and the [Adding a new drive](/docs/gbem/adding_a_new_drive) for more information on how to implement this function.
...
These are usually used for drives - see [Adding a new drive](/docs/gbem/adding_a_new_drive) for more details of their use in the context of drives.
