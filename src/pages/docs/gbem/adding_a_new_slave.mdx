...
The first bit of the driver code for the EL3001 is the #defines for the EEPROM information. These can be read off the netscan's output.

Next we create the #defines for the locations of the data in the slave's PDO.

The value which is a `int16` is located at position `2` and the 8 bits
