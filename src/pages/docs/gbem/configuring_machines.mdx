...
Trinamic, Delta etc. (see [DRIVE SUPPORT](/docs/gbem/drive_support_overview)).
...
See [ADDING A NEW SLAVE](/docs/gbem/adding_a_new_slave) &  [ADDING A NEW DRIVE](/docs/gbem/adding_a_new_drive).
