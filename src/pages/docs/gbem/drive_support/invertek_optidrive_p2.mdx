...
<Image meta={invertek_optidrive_p2_product_shot} alt="Optidrive P2 product" preset="body" width={"50%"} />
...
<Image meta={invertek_optidrive_p2_ethercat} alt="Optidrive P2 EtherCAT" preset="body" width={"50%"} />
