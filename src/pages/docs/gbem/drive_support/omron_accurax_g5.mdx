...
<Image meta={omron_g5_product_shot} alt="G5 product"  />
...
<Row>
    <Col span={5}>Overall ease of use</Col>
    <Col span={6}><Rate disabled defaultValue={3}/></Col>
    <Col span={11}>(Medium, )</Col>
</Row>

<Row>
    <Col span={5}>Drive configuration softwar</Col>
    <Col span={6}><Rate disabled defaultValue={1}/></Col>
    <Col span={11}>(Fiddly to install, no support for high-res screens, 1990s feel to it)</Col>
</Row>
<Row>
    <Col span={5}>Features</Col>
    <Col span={6}><Rate disabled defaultValue={5}/></Col>
    <Col span={11}>(Excellent, they have covered pretty much everything in these drives)</Col>
</Row>
<Row>
    <Col span={5}>Range of motors</Col>
    <Col span={6}><Rate disabled defaultValue={4}/></Col>
    <Col span={11}>(Bit short on shaft options for the motors)</Col>
</Row>
<Row>
    <Col span={5}>Quality of motors</Col>
    <Col span={6}><Rate disabled defaultValue={3}/></Col>
    <Col span={11}>(Outdated motor connectors, hard to make custom cables)</Col>
</Row>
<Row>
    <Col span={5}>Gearbox option</Col>
    <Col span={6}><Rate disabled defaultValue={5}/></Col>
    <Col span={11}>(Excellent)</Col>
</Row>
<Row>
    <Col span={5}>Price</Col>
    <Col span={6}><Rate disabled defaultValue={3}/></Col>
    <Col span={11}>(Roughly €700 for 3A drive excluding cables and motor)</Col>
</Row>
</div>
