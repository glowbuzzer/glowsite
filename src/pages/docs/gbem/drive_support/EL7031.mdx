...
This simple stepper drive does not support the CiA402 drive profile it just contains a bit to enable the motor and a set of bits that signal if the drive is ready to enable, enabled or has and error and warning.
