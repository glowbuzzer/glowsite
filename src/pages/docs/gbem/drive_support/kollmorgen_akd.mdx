...
## Getting working with the glowbuzzer toolkit
...
The code use to apply these can be found in the library

## Initial PDOs



<PdoCard size="small" title="Interpolation time index">
    <p>Address: 0x60C:0x2</p>
    <p>Value: 3 (a -3 exponent to the interpolation time period)</p>
</PdoCard>

<PdoCard size="small" title="Interpolation time period">
    <p>Address: 0x60C2:0x1</p>
    <p>Value: Set to our cycle time (1ms, 2ms, 4ms)</p>
</PdoCard>
...
<PdoCard size="small" title="Activate fieldbus synchronisation">
    <p>Address: 0x36E6:0x0</p>
    <p>Value: 1 (activate)</p>
</PdoCard>


<PdoCard size="small" title="Synchronization supervision of the EtherCAT fieldbus">
    <p>Address: 0x36E8:0x0</p>
    <p>Value: 1 (activate - this will error the drive if the sync. fails - turn off when commissioning)</p>
</PdoCard>

<PdoCard size="small" title="Scaling is done using special DS402 - objects (independent on units)">
    <p>Address: 0x36E9:0x0</p>
    <p>Value: set bit 4</p>
</PdoCard>

<PdoCard size="small" title="drv.opmode">
    <p>Address: 0x35B4:0x0</p>
    <p>Value: 2</p>
</PdoCard>


<PdoCard size="small" title="Motor revolutions">
    <p>Address: 0x6091:0x1</p>
    <p>Value: 1</p>
</PdoCard>

<PdoCard size="small" title="Shaft revolutions">
    <p>Address: 0x6091:0x2</p>
    <p>Value: 1</p>
</PdoCard>

<PdoCard size="small" title="Feed">
    <p>Address: 0x6092:0x1</p>
    <p>Value: 655,360</p>
</PdoCard>

<PdoCard size="small" title="shaft revolutions">
    <p>Address: 0x6092:0x2</p>
    <p>Value: 1</p>
</PdoCard>
