...
You will need to stay in sim mode as obviously we don't have a connection to an EtherCAT network or motor driver ICs on an SPI bus.

Now we can jog a motor. In the joints display we should see these joints moving.
