...
<BogStandardRow>
    <BogStandardCol span={12}><CartesianIcon/>  Generic</BogStandardCol>
    <BogStandardCol span={12}><RobotIcon/>  Staubli</BogStandardCol>
...
<BogStandardCol span={12}><Image src={generic_gbr} width={400}/>    </BogStandardCol>
    <BogStandardCol span={12}><Image src={staubli_gbr} width={400}/>    </BogStandardCol>
</BogStandardRow>

So, follow the simple instructions below for either the Generic or Staubli demos.

<Tabs defaultActiveKey="1"  >
    <TabPane tab={<span><h2><CartesianIcon/>  Generic machine demo - instructions</h2></span>} key="1">
        ### Step 1 - Running &gbr
    ...
    <TabPane tab={<span><h2><RobotIcon/>  Staubli 6-DOF robot demo - instructions</h2></span>} key="2">
        ### Step 1 - Running &gbr
