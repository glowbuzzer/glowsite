...
# Use a custom create react app template to create your starter project
<Tldr>
    - Blah
    - Blah, blah
    - Blah, blah, blah
...
Open the project in your IDE. We use JetBrains but Visual Studio Code will do fine.
