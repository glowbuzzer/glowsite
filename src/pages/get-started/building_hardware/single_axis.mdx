...
You are now ready for the next step, which would be to run up the front-end, &gbc and &gbem and jog a drive. See <Link to="/get-started/motion"> for details on how to do this</Link>.
