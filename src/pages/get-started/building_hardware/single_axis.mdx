...
You are now ready for the next step, which would be to run up the front-end, &gbc and &gbem and jog a drive. See <GlowsiteLink to="/get-started/qs-hardware"> for details on how to do this</GlowsiteLink>.
