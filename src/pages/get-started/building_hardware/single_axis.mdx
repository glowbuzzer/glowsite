...
You are now ready for the next step, which would be to run up the front-end, &gbc and &gbem and jog a drive. See our <GlowsiteLink to="/get-started/qs-hardware">Quick start</GlowsiteLink> for details on how to do this.

## Reference diagram - the ADK-KED connector layout

import azd_ked_connectors from './azd_ked_connectors.svg'

<img className="bg-light" src={azd_ked_connectors} alt="AKD-KED connector diagram"/>
