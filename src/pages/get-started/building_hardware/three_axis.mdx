...
The next step is to get a motor moving. See <GlowsiteLink to="/get-started/motion"> here</GlowsiteLink> for details on how to do this.

Also, see <GlowsiteLink to="/docs/gbem/drive_support/om_azd3a_ked"> here</GlowsiteLink> for details on how to use the Oriental Motor MEX02 software to commission the drive and make the motor move.
