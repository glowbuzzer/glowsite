...
For use with real hardware this needs to run on Linux with real-time extensions. The easiest way to get started with this is to use the Raspberry Pi but of course you can use a desktop version of Linux.

## Step 2 - install Raspberry Pi OS

<InstallPi/>

## Step 3 - Download &gbc on the Raspberry Pi (or Linux)
