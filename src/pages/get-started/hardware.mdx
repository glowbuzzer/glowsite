...
See <Link to="/get-started/building_hardware/single_axis"> building the single axis starter kit</Link> for assembly instructions.
...
See <Link to="/get-started/building_hardware/three_axis"> building the three axis starter kit</Link> for assembly instructions.
...
See <Link to="/get-started/building_hardware/embedded_linux_axis"> building the embedded Linux starter kit</Link> for assembly instructions.
