...
See <GlowsiteLink to="/get-started/kits/single-axis"> building the single axis starter kit</GlowsiteLink> for assembly instructions.
...
See <GlowsiteLink to="/get-started/kits/three-axis"> building the three axis starter kit</GlowsiteLink> for assembly instructions.
...
See <GlowsiteLink to="/get-started/kits/embedded-linux"> building the embedded Linux starter kit</GlowsiteLink> for assembly instructions.
