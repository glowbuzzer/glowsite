...
<StandardCarousel width={"500px"} height={"500px"} fade={true} dotsTop={'480px'} dotsOn={false} pauseOnHover={false} imgdata={[[`${Image1Bank1}`, "image1"],[`${Image2Bank1}`, "image2"],[`${Image3Bank1}`, "image3"],[`${Image4Bank1}`,"image4"],[`${Image5Bank1}`, "image3"]]} />
...
<StandardCarousel width={"600px"} height={"300px"} fade={false} dotsTop={'250px'} dotsOn={true} pauseOnHover={true} imgdata={[[`${Image1Bank2}`,"image1"],[`${Image2Bank2}`, "image2"],[`${Image3Bank2}`,"image3"],[`${Image4Bank2}`,"image4"]]} />
