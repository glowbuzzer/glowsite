...
````shell
https://downloads.glowbuzzer.com/releases/gbc/linux-amd64/&gbc_version;/gbc-&gbc_version;.tgz
````

Linux (64 bit):

````shell
https://downloads.glowbuzzer.com/releases/gbc/rpi/&gbc_version;/gbc-&gbc_version;.tgz
````
...
```shell
wget https://downloads.glowbuzzer.com/releases/gbc/linux-amd64/&gbc_version;/gbc-&gbc_version;.tgz
```
