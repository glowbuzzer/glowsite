...
<List bordered>
    ...
    <List.Item>
        <List.Item.Meta
            ...
            title="Send G-Code to a machine"
            description="G-Code is an easy to use way to control machines. We supply the components to interpret and transmit this G-Code to a machine"
        />
    </List.Item>
    <List.Item>
        <List.Item.Meta
