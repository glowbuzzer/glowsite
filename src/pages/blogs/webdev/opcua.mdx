...
sort: 1
---
import opc_logo from "./opc_logo.png?glowsite"
export const heroImage=opc_logo
...
export const ContentTags =  ["web-dev", "OPC-UA", "node.js", "PLC", "pub/sub"]
...
<TitleImage image={opc_logo} alt="OPC Logo"/>
