...
<StandardCarousel height={"200px"} fade={true} dotsTop={'480px'} dotsOn={false} labelsOn={true} pauseOnHover={false} imgdata={[[`${Image1Platform}`, "Linux IPC"],[`${Image2Platform}`, "Linux SBC"],[`${Image3Platform}`, "Linux SoM"],[`${Image4Platform}`,"STM32 Microcontroller"]]} />
