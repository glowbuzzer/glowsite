...
<StandardCarousel width={"500px"} height={"200px"} fade={true} dotsTop={'480px'} dotsOn={false} pauseOnHover={false} imgdata={[[`${Image1Platform}`, "Linux IPC"],[`${Image2Platform}`, "Linux SBC"],[`${Image3Platform}`, "Linux SoM"],[`${Image4Platform}`,"STM32 Microcontroller"]]} />
