...
import screenshot_raw_planner from "./trajectory_images/screenshot_raw_planner.png?glowsite"

<div style={{margin: "50px"}}>
<Image meta={screenshot_raw_planner} alt="gb trajectory planner" preset="body" width={"100%"}/>
</div>
