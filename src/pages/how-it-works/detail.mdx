...
import {Divider, List, Space, Avatar, Row, Col} from 'antd';
...
<Tldr>
    <TldrItem>Multiple components in the toolkit</TldrItem>
    <TldrItem>Layer 1 - React components</TldrItem>
    <TldrItem>Layer 2 - Real-time control</TldrItem>
    <TldrItem>Layer 3 - Drives & IO interface</TldrItem>
</Tldr>
...
<Row align={"middle"} style={{padding: "10px"}}>
    <Col span={2}/>
    <Col span={22}>
        <li style={{padding: "10px"}}>LAYER 1 is the front-end react components used to build the user interface and
            machine control logic
        </li>
        <li style={{padding: "10px"}}>LAYER 2 is the real-time core control</li>
        <li style={{padding: "10px"}}>LAYER 3 is the interface to drives and IO</li>
    </Col>
</Row>
