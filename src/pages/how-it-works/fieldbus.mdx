...
<Carousel {...settings}>
<div>
    <img src={Image1Fieldbus} width="100px"/>
    </div>
    <div>
        <img src={Image2Fieldbus} width="100px" />
    </div>
    <div>
        <img src={Image3Fieldbus} width="100px"/>
    </div>
    <div>
        <img src={Image4Fieldbus} width="100px"/>
    </div>
    <div>
        <img src={Image5Fieldbus} width="100px"/>
    </div>
    <div>
        <img src={Image6Fieldbus} width="100px" />
    </div>
</Carousel>
</div>
