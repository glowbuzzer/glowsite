...
<Carousel {...settings}>
    ...
    <img src={Image1Fieldbus} height="100px"/>
</div>
    <div>
        <img src={Image2Fieldbus} height="100px" />
    </div>
    <div>
        <img src={Image3Fieldbus} height="100px"/>
    </div>
    <div>
        <img src={Image4Fieldbus} height="100px"/>
    </div>
    <div>
        <img src={Image5Fieldbus} height="100px"/>
    </div>
    <div>
        <img src={Image6Fieldbus}height="100px" />
    </div>
</Carousel>
