...
The glowbuzzer toolkit ships with many front-end React components these are collectively called GBR. You will probably use some of these components unmodified (e.g. the component to connect to a machine) while others can be the starting point for you to modify to your specific needs.
