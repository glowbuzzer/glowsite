...
Front-ends built with the &gbt are web applications and any device running a modern browser that uses the V8 engine (Chrome, and Chromium based browsers e.g., Microsoft Edge, Opera etc.) can happily display the applications. This includes many HMI panels available.
