...
With the &gbt, you can write the new user interface as a React web application, using the &gb library of components for standard functions (connecting to the machine, io, g-code support, jogging, and so on) and write you own new components where needed for your application.
