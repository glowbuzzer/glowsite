...
<div style={{width: "70%"}}>
    <Row>
        <Col span="20" style={{background: '#722ed7', color: '#ffff', padding: '10px 10px'}}>
            # Tier 1
            ## React application
    ...
    <Row>
        <Col span="20" style={{background: '#9254de', color: '#ffff', padding: '10px 10px'}}>
            # Tier 2
    ...
    <Row>
        <Col span="20" style={{background: '#b37feb', color: '#ffff', padding: '10px 10px'}}>
            # Tier 3
    ...
    <Row>
        <Col span="20" style={{background: '#d3adf7', color: '#ffff', padding: '10px 10px'}}>
            # Tier 4
