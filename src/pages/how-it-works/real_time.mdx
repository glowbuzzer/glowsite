...
<div style={{width: "70%"}}>
<Row>
    <Col span="20" style={{background: '#722ed7', color: '#ffff', padding: '10px 10px'}}><div children={Tier1Md}/></Col>
</Row>
<Row>
    <Col span="20" style={{background: '#9254de', color: '#ffff', padding: '10px 10px'}}><div children={Tier2Md}/></Col>
</Row>
<Row>
    <Col span="20" style={{background: '#b37feb', color: '#ffff', padding: '10px 10px'}}><div children={Tier3Md}/> </Col>
</Row>
<Row>
    <Col span="20" style={{background: '#d3adf7', color: '#ffff', padding: '10px 10px'}}><div children={Tier4Md}/> </Col>
</Row>
</div>
