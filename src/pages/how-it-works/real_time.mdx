...
<div style={{width: "70%"}}>
    <Row>
        <Col span="20" style={{background: '#b37feb', padding: '10px 10px'}}>
            # Tier 1
            ## React application
    ...
    <Row>
        <Col span="20" style={{background: '#d3adf7', padding: '10px 10px'}}>
            # Tier 2
    ...
    <Row>
        <Col span="20" style={{background: '#efdbff', padding: '10px 10px'}}>
            # Tier 3
    ...
    <Row>
        <Col span="20" style={{background: '#f9f0ff', padding: '10px 10px'}}>
            # Tier 4
