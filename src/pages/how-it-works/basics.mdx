...
The WebSockets interface used by the front-end, is provided by the glowbuzzer toolkit’s real-time control software that runs either on Linux or on an embedded microcontroller.
