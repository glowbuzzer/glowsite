...
export const TextMd = `The glowbuzzer toolkit allows you to build machine control applications using a web stack.\n\n
A machine is a combination of motors and IO. It could be an industrial robot arm, a cutting machine, a piece of laboratory equipment.\n\n
...
The WebSockets interface the front-end reads and writes to is provided by the glowbuzzer toolkit’s real-time control software that runs either on Linux or on an embedded microcontroller.\n\n
...
<Tldr>
    ...
    <TldrItem>Designed to be embedded</TldrItem>
</Tldr>


<Markdown children={TextMd} options={{ forceBlock: true }}/>
...
<Divider orientation="left" plain><h1>Summary of features/benefits</h1></Divider>
