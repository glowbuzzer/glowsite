...
<Tldr>
    <TldrItem>Runs on embedded Linux</TldrItem>
    <TldrItem>Runs on dual core high-end microcontrollers</TldrItem>
    <TldrItem>Integreates with motor driver ICs</TldrItem>
    <TldrItem>EtherCAT master is ported to microcontroller</TldrItem>
</Tldr>
