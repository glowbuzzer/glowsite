                ...
                <div className="top-section-container">
                    <div className="top-section">
                        <div className="left">
                            ...
                            <div className="title">
                                Control EtherCAT drives from web-stack motion control
                            </div>
                            <div className="description">
                                <p>
                                    Use either embedded Linux or high-end microcontroller machine /
                                    robot controls
                                </p>
...
export default DrivesLandingPage
