                ...
                <div className="top-section-container">
                    <div className="top-section">
                        <div className="left">
                            ...
                            <div className="title">Control EtherCAT robot joints</div>
                            <div className="description">
                                <p>
                                    EtherCAT master exposed through a websockets interface to allow
                                    web-applications to easily control machines and robots
                                </p>
                                <p>
                                    Full motion control including forward and inverse kinematics and
                                    co-ordinated motion for complex kinematics structures integrated
                                    into the EtherCAT master
                                </p>
                                <p>Runs on embedded Linux and microcontroller platforms</p>
                                <p>Software PLC functions accessible over websockets interface</p>
                            </div>
                        </div>
                        <div className="right">
...
export default JointsLandingPage
